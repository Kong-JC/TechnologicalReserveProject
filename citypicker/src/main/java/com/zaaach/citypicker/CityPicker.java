...
//    public CityPicker(Activity mActivity) {
//        this.mActivity = new WeakReference<>(mActivity);
//        mFragmentManager = new WeakReference<>(mActivity.());
//    }
    public CityPicker(FragmentManager fm) {
...
//    }
    ...
    public static CityPicker from(FragmentManager fm) {
        return new CityPicker(fm);
    }
